...
// This class is a modified version of SpriteCache that fixes a bug for a sprite cache drawing method
// that Apparatus has apparently been hoarding for years.
// (Apparatus 1.2.1 was released in 2013, and a similar fix apparently made its way into libGDX in 2020)
// https://github.com/libgdx/libgdx/commit/f3364b32f64107093f2c5207170d8cf8ac627dad

public class BetterSpriteCache extends SpriteCache {
	...
	public BetterSpriteCache (int size, boolean useIndices) {
	 ...
	 * @param size The maximum number of images this cache can hold. The memory required to hold the images is allocated up front.
	 * @param useIndices If true, indexed geometry will be used. */
	public BetterSpriteCache (int size, ShaderProgram shader, boolean useIndices) {
		this.shader = shader;
